 ...
 */
package dev.witheredflowers.whativelearned.lunchtray.model
...
import dev.witheredflowers.whativelearned.lunchtray.data.DataSource
...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        // this is made using elvis operator null safety
