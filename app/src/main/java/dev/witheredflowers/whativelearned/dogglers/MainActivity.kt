...
import dev.witheredflowers.whativelearned.databinding.ActivityMainDogglersBinding

class MainActivity : AppCompatActivity() {
	
	private lateinit var binding: ActivityMainDogglersBinding
	private lateinit var listIntent: Intent
	
	override fun onCreate(savedInstanceState: Bundle?) {
		super.onCreate(savedInstanceState)
		// Setup view binding
		binding = ActivityMainDogglersBinding.inflate(layoutInflater)
